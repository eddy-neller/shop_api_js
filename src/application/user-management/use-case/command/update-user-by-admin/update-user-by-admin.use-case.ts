...
import type { UpdateUserByAdminCommand } from "@/application/user-management/use-case/command/update-user-by-admin/update-user-by-admin.command";
...
import {
  type UserRole,
  toUserRole,
} from "@/domain/user/value-object/access/user-role";
